...
const tabs: { id: Tab; label: string; icon: React.ReactNode }[] = [
  ...
  { id: 'lab',      label: 'Lab',       icon: <svg viewBox="0 0 24 24" fill="none"><path d="M9 3h6M9 3v8l-4 9h14l-4-9V3M9 3H7M15 3h2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/><circle cx="14" cy="16" r="1" fill="currentColor"/></svg> },
